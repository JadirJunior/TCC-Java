...
import prjtcc.model.ChartCommands;
        ...
        choiceBox.getSelectionModel().selectedIndexProperty().addListener((ObservableValue<? extends Number> ov, Number old_val, Number new_val) -> { 
            ...
            switch (new_val.intValue()) {
                case 0:
                    ...
                    List<Integer> valores = new ChartCommands(data).getProdutosAdicionados(Prazo.UMA_SEMANA);
                    setValues(series1, 
                ...
                case 1:
                    ...
                    List<Integer> valores2 = new ChartCommands(data).getProdutosAdicionados(Prazo.UM_MES);
                    setValues(series1, 
                ...
                case 2:
                    ...
                    List<Integer> valores3 = new ChartCommands(data).getProdutosAdicionados(Prazo.SEIS_MESES);
                setValues(series1, 
                ...
                case 3:
                    ...
                    List<Integer> valores4 = new ChartCommands(data).getProdutosAdicionados(Prazo.UM_ANO);
                setValues(series1, 
