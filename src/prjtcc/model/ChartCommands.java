...
public class ChartCommands {
   ...
   public List<Integer> getProdutosAdicionados(Prazo prazo) {
       ...
       if (prazo.equals(prazo.UMA_SEMANA)) {
           ...
           List<Integer> values = getProductsByDay(datas);
           return values;
       }
       
       else if (prazo.equals(prazo.UM_MES)) {
           List<String> datas = DateModel.getLastTwoMouth(Mes);
           List<Integer> values = getProductsByMonth(datas);
           return values;
       }
   ...
   private List<Integer> getProductsByMonth(List<String> months) {
       ResultSet res = null;
       con = new Conexao();
   ...
   private List<Integer> getProductsByDay(List<String> days) {
       ResultSet res = null;
       con = new Conexao();
